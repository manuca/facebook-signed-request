...
class SignedRequestTest < Test::Unit::TestCase
  ...
  test 'data of valid request is parsed to ruby hash with symbols as keys' do
    ...
    key_classes = request.data.map { |k, _v| k.class } | [Symbol]
  ...
  test 'request with :strict => true fails for expired oauth token' do
    exception = assert_raise ArgumentError do
      Facebook::SignedRequest.new(@valid_request, strict: true)
    end
  ...
  test 'encode and sign request params' do
    ...
    _, payload = reencoded_request.split('.', 2)
  ...
  test 'ring encoding request with invalid base64 signature and payload' do
    fake = { 'algorithm' => 'HMAC-SHA256', 'expires' => 1_309_186_800, 'issued_at' => 1_309_183_033,
             'oauth_token' => '111111111111111|2.AQDpIv3FOWbnCv8z.3600.1111111100.1-1111100000|0vSxxsZC1R_I6fb_Jw2I8WEXztE', 'user' => { 'country' => 'en', 'locale' => 'en_US', 'age' => { 'min' => 21 } }, 'user_id' => '1111100000' }
